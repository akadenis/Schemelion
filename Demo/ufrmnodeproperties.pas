...
type
  ...
  TEvsNodeProperties = class(TForm)
    ...
    btnBackgroundMargins: TButton;
		UpDownMargin1: TUpDown;
		UpDownMargin2: TUpDown;
		UpDownRightPins: TUpDown;
    ...
    for I := 0 to N.Count - 1 do
      ...
      begin
        ...
        try
          ...
          ElemLeftPins := StrToInt(edtLeftPins.Text);
          ElemRightPins := StrToInt(edtRightPins.Text);
